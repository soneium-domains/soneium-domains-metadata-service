...
exports.avatarMetadata = void 0;
var node_fetch_1 = require("node-fetch");
var base_1 = require("../base");
var config_1 = require("../config");
var avatar_1 = require("../service/avatar");
var network_1 = __importDefault(require("../service/network"));
function avatarMetadata(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name, networkName, provider, meta, error_1, errCode;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, avatar_1.getAvatarMeta)(provider, name, networkName)];
                case 2:
                    meta = _b.sent();
                    if (meta) {
