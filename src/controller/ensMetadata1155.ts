...
export async function ensMetadata1155(req: Request, res: Response) {
  ...
  const contractAddress = process.env.ADDRESS_NAME_WRAPPER || '0x02Cd40daE88c503ef462b05adAc329a7F87A6421';
  const networkName = 'minato'
